        ...
        public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
                http.csrf(csrf -> csrf.disable())
                                ...
                                .authorizeHttpRequests(auth -> auth
                                                ...
                                                .requestMatchers("/oauth2/**", "/login/**", "/success", "/error")
                                                .permitAll()
                                                ...
                                                .requestMatchers(HttpMethod.POST, "/api/vnpay/create")
                                                .hasAnyRole("OWNER", "USER", "ADMIN")
                                                ...
                                                .requestMatchers(HttpMethod.GET, "/api/hotels/owner/my-hotels")
                                                .hasRole("OWNER")
                                                // Public Info endpoints
                                                .requestMatchers(HttpMethod.GET, "/api/info/**").permitAll()
                                                .requestMatchers(HttpMethod.POST, "/api/info/contact/message")
                                                .permitAll()
                                                // Public Geocoding endpoints
                                                .requestMatchers(HttpMethod.POST, "/api/geocoding/geocode-address")
                                                .permitAll()
                                                .requestMatchers(HttpMethod.POST, "/api/geocoding/place-autocomplete")
                                                .permitAll()
                                                .requestMatchers(HttpMethod.POST, "/api/geocoding/place-details")
                                                .permitAll()
                                                // Admin Geocoding endpoints
                                                .requestMatchers(HttpMethod.POST, "/api/geocoding/admin/**")
                                                .hasRole("ADMIN")
                                                ...
                                                .requestMatchers(HttpMethod.PUT, "/api/hotels/{id}").hasRole("OWNER")
                                                .requestMatchers(HttpMethod.PUT, "/api/hotels/{id}/discount")
                                                .hasRole("OWNER")
                                                ...
                                                .hasAnyRole("OWNER", "USER", "ADMIN")
                                                .requestMatchers(HttpMethod.PUT, "/api/bookings/{id}/pay")
                                                .hasRole("USER")
                                                .requestMatchers(HttpMethod.GET, "/api/bookings/{id}").permitAll() // Cho
                                                                                                                   // phép
                                                                                                                   // public
                                                                                                                   // để
                                                                                                                   // quét
                                                ...
                                                .requestMatchers(HttpMethod.POST, "/api/hotels/{id}/reviews")
                                                .hasRole("USER")
                                                ...
                                                .hasAnyRole("OWNER", "USER", "ADMIN")
                                                .requestMatchers(HttpMethod.PUT, "/api/user/password")
                                                .hasAnyRole("OWNER", "USER", "ADMIN")
                                                // Role-based API - Wallet
                                                .requestMatchers(HttpMethod.GET, "/api/wallet/balance")
                                                .hasAnyRole("OWNER", "USER", "ADMIN")
                                                // Role-based API - Withdraws
                                                .requestMatchers(HttpMethod.POST, "/api/withdraws")
                                                ...
                                                .hasAnyRole("OWNER", "USER")
                                                .requestMatchers(HttpMethod.PUT, "/api/withdraws/{id}/approve")
                                                .hasRole("ADMIN")
                                                .requestMatchers(HttpMethod.PUT, "/api/withdraws/{id}/reject")
                                                .hasRole("ADMIN")
                                                ...
                                                .requestMatchers(HttpMethod.PUT, "/api/admin/transactions/{id}/approve")
                                                .hasRole("ADMIN")
                                                .requestMatchers(HttpMethod.GET, "/api/admin/transactions")
                                                .hasRole("ADMIN")
                                                .requestMatchers(HttpMethod.GET, "/api/admin/transactions/{id}")
                                                .hasAnyRole("ADMIN", "OWNER")
                                                .requestMatchers(HttpMethod.GET,
                                                                "/api/admin/transactions/owner/my-transactions")
                                                .hasRole("OWNER")
                                                .requestMatchers(HttpMethod.GET,
                                                                "/api/admin/transactions/revenue/admin")
                                                .hasRole("ADMIN")
                                                .requestMatchers(HttpMethod.GET,
                                                                "/api/admin/transactions/revenue/owner")
                                                .hasRole("OWNER")
                                                // Admin Hotel Management
                                                .requestMatchers(HttpMethod.GET, "/api/admin/hotels/**")
                                                .hasRole("ADMIN")
                                                .requestMatchers(HttpMethod.PUT, "/api/admin/hotels/**")
                                                .hasRole("ADMIN")
                                                // Admin Review Management
                                                .requestMatchers(HttpMethod.GET, "/api/admin/reviews").hasRole("ADMIN")
                                                .requestMatchers(HttpMethod.DELETE, "/api/admin/reviews/**")
                                                .hasRole("ADMIN")
                                                // All others
