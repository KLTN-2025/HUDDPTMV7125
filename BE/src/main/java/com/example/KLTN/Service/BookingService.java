...
public class BookingService implements BookingServiceImpl {
    ...
    public ResponseEntity<Apireponsi<String>> payBooking(Long id
    ) {
        try {
            ...
            // Tạo QR code từ dữ liệu text trực tiếp
            Path qrFilePath = qrCodeService.generateQrToFile(qrString, qrFileName);
            ...
            return httpResponseUtil.ok("Payment Success", "/uploads/qr/" + qrFileName + ".png");
